					...
					<ul class="nav pull-right">
						...
						<li class="dropdown hidden-phone">
							...
							<ul class="dropdown-menu messages">
                            	...
                            	<li>
                                    <a href="#">
										<span class="avatar"><img src="front-end/img/avatar.jpg" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Łukasz Holeczek
										     </span>
                                ...
                                <li>
                                    <a href="#">
										<span class="avatar"><img src="front-end/img/avatar2.jpg" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Megan Abott
										     </span>
                                ...
                                <li>
                                    <a href="#">
										<span class="avatar"><img src="front-end/img/avatar3.jpg" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Kate Ross
										     </span>
								...
								<li>
                                    <a href="#">
										<span class="avatar"><img src="front-end/img/avatar4.jpg" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Julie Blank
										     </span>
                                ...
                                <li>
                                    <a href="#">
										<span class="avatar"><img src="front-end/img/avatar5.jpg" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Jane Sanders
										     </span>
				...
				<div class="widget span3 red" onTablet="span6" onDesktop="span3">
					...
					<div class="content">
						...
						<div class="browserStat big">
							<img src="front-end/img/browser-chrome-big.png" alt="Chrome">
							<span>34%</span>
						</div>
						<div class="browserStat big">
							<img src="front-end/img/browser-firefox-big.png" alt="Firefox">
							<span>34%</span>
						</div>
						<div class="browserStat">
							<img src="front-end/img/browser-ie.png" alt="Internet Explorer">
							<span>34%</span>
						</div>
						<div class="browserStat">
							<img src="front-end/img/browser-safari.png" alt="Safari">
							<span>34%</span>
						</div>
						<div class="browserStat">
							<img src="front-end/img/browser-opera.png" alt="Opera">
							<span>34%</span>
						</div>	
				...
				<div class="box black span4" onTablet="span6" onDesktop="span4">
					...
					<div class="box-content">
						<ul class="dashboard-list metro">
							<li class="green">
								<a href="#">
									<img class="avatar" alt="Lucas" src="front-end/img/avatar.jpg">
								</a>
							...
							<li class="yellow">
								<a href="#">
									<img class="avatar" alt="Bill" src="front-end/img/avatar9.jpg">
								</a>
							...
							<li class="red">
								<a href="#">
									<img class="avatar" alt="Jane" src="front-end/img/avatar5.jpg">
								</a>
							...
							<li class="blue">
								<a href="#">
									<img class="avatar" alt="Kate" src="front-end/img/avatar6.jpg">
								</a>
